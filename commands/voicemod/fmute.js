...
module.exports = {
  ...
  if (!user) return message.reply("Whom do you wanna forcemute?");
  ...
  if (found == 1) {
    ...
    message.channel.send(`<:Demon_VcMuted:829768691154681928> ${user} muted ${message.author} mic`);
