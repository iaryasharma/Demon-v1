...
const canvas = createCanvas(1000, 333)
    ...
    const background = await loadImage('https://cdn.glitch.com/a50382e2-8ddd-4565-bb8a-dc8567f3b5b9%2Fwallpaper.png?v=1614697015128');
    ...
    ctx.closePath();
    ctx.clip();
    const avatar = await loadImage(user.user.displayAvatarURL({ format: "jpg", size: 4096 }));
